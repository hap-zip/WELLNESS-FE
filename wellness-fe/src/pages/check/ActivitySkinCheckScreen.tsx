  ...
  return (
    <SafeAreaView edges={['top', 'bottom']} style={styles.screen}>
      ...
      <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
        ...
        <TextInput accessibilityLabel="오늘의 활동과 피부 메모" maxLength={120} multiline onChangeText={(memo) => updateDraft({ memo })} placeholder="평소와 달랐던 점을 적어주세요." placeholderTextColor="#858D86" style={styles.memo} textAlignVertical="top" value={draft.memo} />
