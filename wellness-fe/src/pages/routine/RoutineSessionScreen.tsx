...
export default function RoutineSessionScreen() {
  ...
  if (isLoading || !routine) return <SafeAreaView edges={['top', 'bottom']} style={styles.center}><ActivityIndicator color={colors.primary} /></SafeAreaView>;
