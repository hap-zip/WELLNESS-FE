...
const styles=StyleSheet.create({base:{minHeight:layout.ctaHeight,alignItems:'center',justifyContent:'center',paddingHorizontal:spacing.md,borderRadius:radius.md},primary:{backgroundColor:colors.primary},secondary:{borderWidth:1,borderColor:colors.border,backgroundColor:colors.surface},danger:{backgroundColor:colors.dangerSoft},text:{backgroundColor:'transparent'},label:{fontSize:15,lineHeight:22,fontWeight:'700'},primaryLabel:{color:colors.white},secondaryLabel:{color:colors.text},dangerLabel:{color:colors.danger},textLabel:{color:colors.primary},disabled:{opacity:.38},pressed:{opacity:motion.pressOpacity}});
