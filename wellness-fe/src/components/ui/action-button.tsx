...
const styles=StyleSheet.create({base:{minHeight:layout.ctaHeight,alignItems:'center',justifyContent:'center',paddingHorizontal:spacing.lg,borderRadius:radius.md},primary:{backgroundColor:colors.primary},secondary:{borderWidth:1,borderColor:colors.border,backgroundColor:colors.surface},danger:{backgroundColor:colors.bodySoft},text:{backgroundColor:'transparent'},label:{fontSize:15,lineHeight:22,fontWeight:'800',letterSpacing:-.2},primaryLabel:{color:colors.white},secondaryLabel:{color:colors.text},dangerLabel:{color:colors.body},textLabel:{color:colors.primary},disabled:{opacity:.38},pressed:{opacity:motion.pressOpacity}});
